...
import { u as unionType, s as stringType, i as instanceOfType, c as custom, am as lazyType, at as nullType, n as numberType, a6 as booleanType, r as recordType, a4 as arrayType, o as objectType, an as literalType, aK as unknownType, ay as optionalType, a as anyType, e as enumType, as as neverType, ag as intersectionType, Q as ZodOptional, b as ZodObject, K as ZodNull, g as ZodArray, a0 as ZodUnion, X as ZodString, M as ZodNumber, m as ZodDate, p as ZodDefault, J as ZodNever } from './v3.mjs';
...
secureJsonParse$1.exports.safeParse = safeParse$1;
secureJsonParse$1.exports.scan = filter$1;

var secureJsonParseExports$1 = secureJsonParse$1.exports;
  ...
  return {
    ...
    validatePartialResult({ value, latestObject, isFirstDelta, isFinalDelta }) {
      ...
      for (let i = 0; i < inputArray.length; i++) {
        ...
        const result = safeValidateTypes$1({ value: element, schema });
...
var ToolExecutionError = class extends AISDKError$1 {
  constructor({
    ...
    toolCallId,
    cause,
    message = `Error executing tool ${toolName}: ${getErrorMessage$2(cause)}`
  }) {
...
var InvalidToolArgumentsError = class extends AISDKError$1 {
  constructor({
    ...
    toolName,
    cause,
    message = `Invalid arguments for tool ${toolName}: ${getErrorMessage$2(
      cause
    )}`
  }) {
...
async function doParseToolCall({
  ...
  const parseResult = toolCall.args.trim() === "" ? safeValidateTypes$1({ value: {}, schema }) : safeParseJSON$1({ text: toolCall.args, schema });
...
export { AISpanType as A, getValidTraceId as B, wrapMastra as C, DeepSeekSchemaCompatLayer as D, selectFields as E, ModelSpanTracker as F, GoogleSchemaCompatLayer as G, checkEvalStorageFields as H, MetaSchemaCompatLayer as M, OpenAIReasoningSchemaCompatLayer as O, ToolStream as T, shutdownAITracingRegistry as a, convertToCoreMessages as b, customAlphabet as c, generateEmptyFromSchema as d, embedMany as e, fetchWithRetry as f, getAllAITracing as g, convertSchemaToZod as h, deepMerge as i, OpenAISchemaCompatLayer as j, AnthropicSchemaCompatLayer as k, applyCompatLayer as l, isZodType as m, jsonSchema as n, output_exports as o, parseSqlIdentifier as p, generateText as q, generateObject as r, setupAITracing as s, streamText as t, streamObject as u, delay as v, ensureToolProperties as w, makeCoreTool as x, createMastraProxy as y, getOrCreateSpan as z };
